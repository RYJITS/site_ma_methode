...
export const orchestratorProjectCards = [
  {
    ...
    "details": {
      ...
      "avancement": "Etat du projet: reserve a l'usage interne. Fonctionnement: non teste faute d'informations suffisantes. Securite: reserve au prive. Ma Methode: fiche explicative visible. Publication externe: interne.",
      "capabilities": [
  ...
  },
  {
    ...
    "functions": [
      ...
      "Creer des snapshots d'archive pour garder un etat du planning",
  ...
  {
    "id": "05-bord-planif-design-phase6",
    "category": "tools",
    "name": "Bord PLANIF - Cockpit de planification MRP",
    "comment": "Application web autonome simulant un cockpit de planification MRP à partir d'une structure métier analysée, avec interface type Excel et données fictives.",
    "image": "public/orchestrator/thumbnails/05-bord-planif-design-phase6.webp",
    "githubUrl": "https://github.com/RYJITS/bord_planif",
    "linkPolicy": {
      "exposure": "public-links",
      "publicationAllowed": true,
    ...
    "ficheUrl": "public/orchestrator/fiches/05-bord-planif-design-phase6.md",
    "localPath": "05_Bord_PLANIF_design_phase6",
    "stack": [
      "HTML statique"
    ],
    "status": {
    ...
    "screenshots": [
      "public/orchestrator/captures/05-bord-planif-design-phase6/05-bord-planif-design-phase6-2026-09-02_15-03-26-desktop.png",
      "public/orchestrator/captures/05-bord-planif-design-phase6/05-bord-planif-design-phase6-2026-09-02_15-03-26-mobile.png"
    ],
    "mediaPolicy": {
      "exposure": "publication-ready",
      "publicationAllowed": true,
  ...
  {
    "id": "05-bord-planif-design-phase6-redo",
    "category": "tools",
    "name": "Bord PLANIF - Cockpit de planification MRP",
    "comment": "Application web autonome simulant un cockpit de planification MRP à partir d'une structure métier analysée, avec interface type Excel et données fictives.",
    "image": "public/orchestrator/thumbnails/05-bord-planif-design-phase6-redo.webp",
    "githubUrl": "https://github.com/RYJITS/bord_planif",
    "linkPolicy": {
      "exposure": "public-links",
      "publicationAllowed": true,
    ...
    "ficheUrl": "public/orchestrator/fiches/05-bord-planif-design-phase6-redo.md",
    "localPath": "05_Bord_PLANIF_design_phase6_redo",
    "stack": [
      "HTML statique"
    ],
    "status": {
    ...
    "screenshots": [
      "public/orchestrator/captures/05-bord-planif-design-phase6-redo/05-bord-planif-design-phase6-redo-2026-09-02_15-03-30-desktop.png",
      "public/orchestrator/captures/05-bord-planif-design-phase6-redo/05-bord-planif-design-phase6-redo-2026-09-02_15-03-30-mobile.png"
    ],
    "mediaPolicy": {
      "exposure": "publication-ready",
      "publicationAllowed": true,
  ...
  {
    "id": "05-skyia-worktree-uiux-2026",
    "category": "ai",
    "name": "SkyIA - Protocole de Jugement Adversarial pour Modèles IA",
    "comment": "Plateforme open source dédiée à l'évaluation, au benchmark et au suivi des performances des modèles d'intelligence artificielle via des duels structurés et des sessions comparatives.",
    "image": "public/orchestrator/thumbnails/05-skyia-worktree-uiux-2026.webp",
    "githubUrl": "https://github.com/RYJITS/skyia",
    "linkPolicy": {
      "exposure": "public-links",
      "publicationAllowed": true,
    ...
    "ficheUrl": "public/orchestrator/fiches/05-skyia-worktree-uiux-2026.md",
    "localPath": "05_skyia__worktree_uiux_2026",
    "stack": [
      "Vite/Dev server",
      "React",
      "Node.js"
    ...
    "details": {
      "application": "SkyIA est une plateforme full-stack permettant d'évaluer et de comparer des modèles d'intelligence artificielle via des duels structurés. L'application se compose d'un frontend React/Vite pour l'interface utilisateur et d'une API PHP/MySQL pour la persistance des données et la logique métier. Les utilisateurs peuvent lancer des conversations avec un ou plusieurs modèles, organiser des duels adversariaux, sauvegarder leurs sessions, consulter des rapports détaillés et exporter ces rapports au format PDF. L'interface propose également un mode immersif avec des effets visuels rétro pour une expérience utilisateur unique.",
      "fonctionnement": "L'application fonctionne en deux couches principales : un frontend React/Vite gérant l'interface utilisateur et une API PHP/MySQL assurant la persistance des données et la logique métier. Le frontend pilote les interactions utilisateur (conversations, duels, sauvegardes) tandis que l'API gère l'authentification, le routage vers les fournisseurs de modèles, le streaming des réponses et l'archivage des rapports. Les services frontaux intègrent des mécanismes de compaction de contexte pour les modèles à faible capacité token et des optimisations pour le streaming SSE afin d'améliorer l'expérience utilisateur.",
      "conception": "Le projet a été conçu avec une architecture modulaire et sécurisée, séparant clairement les responsabilités entre frontend et backend. Le frontend utilise React avec TypeScript pour un typage strict et une maintenabilité accrue, tandis que le backend repose sur une API PHP/MySQL pour une compatibilité avec les hébergements mutualisés. La sécurité est renforcée par un stockage chiffré des clés BYOK côté utilisateur et une séparation des données sensibles (tokens, sessions) des données publiques (rapports, statistiques). L'interface utilisateur a été pensée pour être intuitive tout en intégrant des éléments visuels inspirés des interfaces rétro (style terminal, effets CRT) pour une expérience immersive. L'architecture a été optimisée pour une évolutivité et une maintenabilité à long terme, avec des tests automatisés et des audits de sécurité intégrés.",
      "avancement": "Etat du projet: pret cote usage public. Fonctionnement: fonctionnel. Securite: OK pour une presentation publique. Ma Methode: fiche explicative visible. Publication externe: candidat public, validation finale separee.",
      "capabilities": [
        "Lancement de duels IA structurés",
        "Comparaison multi-modèles en temps réel",
        "Archivage et export de rapports de duel",
        "Benchmark de latence des modèles",
        "Gestion des modèles personnalisés (BYOK)",
    ...
    "highlights": [
      "Fournir une interface centralisée et un protocole standardisé pour comparer objectivement les modèles IA (gratuits, serveurs, BYOK), archiver les résultats, mesurer les latences et générer des rapports détaillés. Destinée aux chercheurs, développeurs et observatoires de modèles.",
      "Etat du projet: pret cote usage public.",
      "Fonctionnement: fonctionnel.",
      "Securite: OK pour une presentation publique."
    ],
    ...
    "screenshots": [
      "public/orchestrator/captures/05-skyia-worktree-uiux-2026/05-skyia-worktree-uiux-2026-2026-09-02_15-03-36-desktop.png",
      "public/orchestrator/captures/05-skyia-worktree-uiux-2026/05-skyia-worktree-uiux-2026-2026-09-02_15-03-36-mobile.png"
    ],
    "mediaPolicy": {
      "exposure": "publication-ready",
      "publicationAllowed": true,
  ...
  },
  {
    ...
    "details": {
      ...
      "techniques": [
        ...
        "Planche 4x4 pour generer quatre recommandations en un seul appel",
        "Planche finale 2x2 pour produire face, profils et dos en un seul appel",
        "Quota journalier stocke cote serveur par empreinte de client et de session",
        "Prompts optimises pour conserver l'identite et le contexte",
  ...
  {
    "id": "20-morphostyle-publish",
    "category": "design",
    "name": "MorphoStyle Studio - Plateforme de génération et partage de coiffures assistée par IA",
    "comment": "Plateforme web permettant de générer des propositions de coiffures personnalisées via intelligence artificielle et de les partager avec une communauté.",
    "image": "public/orchestrator/thumbnails/20-morphostyle-publish.webp",
    "linkPolicy": {
      "exposure": "public-links",
      "publicationAllowed": true,
      "githubShowcaseAllowed": false,
    ...
    "ficheUrl": "public/orchestrator/fiches/20-morphostyle-publish.md",
    "localPath": "20_morphostyle_publish",
    "stack": [
      "Dossier projet"
    ],
    "status": {
    ...
    "details": {
      "application": "MorphoStyle Studio est une application web progressive (PWA) conçue pour aider les utilisateurs à découvrir des styles de coiffure adaptés à leur morphologie faciale. Le projet intègre une interface de génération assistée par IA, permettant de créer des propositions personnalisées à partir de photos ou de modèles 3D. Les utilisateurs peuvent explorer des planches de tendances, valider des styles, et partager leurs créations au sein d'une communauté sécurisée. Le système inclut des mécanismes de validation des âges et de gestion des retries pour garantir une expérience robuste.",
      "fonctionnement": "L'application fonctionne en trois étapes principales : 1) Analyse morphologique via IA pour proposer des styles adaptés, 2) Prévisualisation interactive des propositions sur des modèles ou photos, 3) Partage sécurisé des créations avec contrôle des paramètres de confidentialité. Le backend gère les requêtes IA, les validations, et les interactions utilisateur, tandis que le frontend propose une interface responsive avec des animations fluides pour les transitions entre planches.",
      "conception": "Le projet a été conçu comme une PWA pour offrir une expérience utilisateur fluide et accessible sur tous les appareils. L'architecture repose sur une séparation claire entre frontend (React avec TypeScript) et backend (Node.js). Les choix de design incluent l'utilisation de Tailwind CSS pour le styling, des animations CSS pour les transitions, et une gestion stricte des permissions pour les publications. La sécurité est renforcée par une politique de contenu strict (CSP) et une validation systématique des entrées utilisateur.",
      ...
      "capabilities": [
        "Génération de styles de coiffure personnalisés via IA",
        "Prévisualisation interactive avec animations fluides",
        "Partage sécurisé des créations avec contrôle des paramètres de confidentialité",
        "Navigation entre planches de profils et de tendances",
        "Validation des âges pour exclure les suggestions inappropriées",
        "Gestion automatique des retries en cas de saturation du service IA",
        "Mode OpenAI Image avec quota limité",
      ...
      "tools": [
        ...
        "Tailwind CSS",
        "PostCSS",
        "Python (scripts de génération de planches)",
        "MySQL (base de données pour le socle multi-utilisateur)",
        "Hostinger (hébergement cible)"
      ],
      "techniques": [
        "PWA (Progressive Web App)",
        "IA générative pour les propositions de coiffures",
        "Validation des entrées utilisateur côté serveur",
        "Gestion des retries avec délai exponentiel",
        "Schéma JSON robuste pour l'analyse morphologique",
        "Animations CSS pour les transitions fluides",
        "CSP (Content Security Policy) pour la sécurité",
        "Responsive Design avec Tailwind CSS"
      ],
      "automations": [
        "Scripts Python pour la génération automatique de planches de profils et de tendances",
        "Validation automatique des âges pour exclure les suggestions inappropriées",
        "Gestion automatique des retries en cas de saturation du service IA"
      ]
    },
    "progress": [
    ...
    "highlights": [
      "Offrir aux utilisateurs un outil interactif pour explorer des styles de coiffure adaptés à leur morphologie faciale, avec une interface de partage sécurisée et des fonctionnalités de personnalisation avancées.",
      "Etat du projet: candidat public avec controles a finaliser.",
      "Fonctionnement: non teste faute d'informations suffisantes.",
      "Securite: OK pour une presentation publique."
    ],
    "functions": [
      "Génération de propositions de coiffures personnalisées via IA",
      "Prévisualisation interactive des styles sur photos ou modèles 3D",
      "Partage sécurisé des créations au sein d'une communauté",
      "Gestion des préférences de confidentialité pour les publications",
      "Navigation entre différentes planches de profils et styles",
      "Génération de planches de tendances et de recommandations",
      "Validation des âges pour exclure les suggestions inappropriées",
      "Gestion des retries automatiques en cas de saturation du service IA"
    ],
    "screenshots": [],
    "mediaPolicy": {
      "exposure": "none",
  ...
  },
  {
    ...
    "category": "ai",
    "name": "Cerveau IA",
    "comment": "Espace de travail IA local qui organise les instructions, la memoire, les competences, les integrations API et les projets dans un systeme coherent.",
