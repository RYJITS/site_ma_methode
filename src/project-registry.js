...
export const orchestratorProjectCards = [
  ...
  },
  {
    ...
    "details": {
      ...
      "conception": "Il a ete concu comme un espace prive et pratique, indexe par l'orchestrateur mais non publie. La structure privilegie les procedures lisibles et les reperes de maintenance, car le contenu touche a l'infrastructure et peut contenir des informations sensibles.",
      "capabilities": [
