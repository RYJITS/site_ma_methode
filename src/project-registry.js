  ...
  },
  {
    ...
    "details": {
      ...
      "tools": [
        ...
        "Markdown pour la memoire et les specifications",
        "Mermaid pour les schemas",
        "Futurs sous-agents Codex pour l'execution"
      ],
      "techniques": [
        "Node.js"
      ],
    ...
    "functions": [
      "Cadrer une mission design avant toute recherche ou implementation",
      "Auditer un site ou projet web existant",
      "Qualifier des sources d'inspiration, de methode et d'execution",
      "Produire une direction artistique validee visuellement",
      "Faire choisir trois layouts distincts pour chaque page du perimetre",
      "Attendre le choix utilisateur avant implementation",
      "Construire un design system coherent",
      "Modifier un projet cible uniquement en copie isolee",
      "Verifier le rendu avec captures, tests et QA visuelle",
      "Controle automatisable detecte via npm run check."
    ],
    "screenshots": [],
    "mediaPolicy": {
